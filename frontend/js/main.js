$(function() {
   ...
   ========================================================================== */
    ...
    $('.countdown').downCount({
        date: '10/07/2017 12:00:00' // m/d/y
    });
   ...
   ========================================================================== */
    ...
    function register($form) {
        $.ajax({
            ...
            data: JSON.stringify({
              email: $('#mc-form input[name=email]').val(),
              firstname: $('#mc-form input[name=firstname]').val(),
              lastname: $('#mc-form input[name=lastname]').val(),
              subscribe: $('#mc-form input[name=subscribe]').val() === "on",  
            }),
            cache: false,
            dataType: 'json',
            processData: false,
            ...
            error: function(err) {
                $('#mc-notification').hide().html('<span class="alert">' + err.responseJSON.data + '</span>').fadeIn("slow");
            },
